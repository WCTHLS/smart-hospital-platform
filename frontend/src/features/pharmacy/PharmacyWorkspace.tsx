...
import { 
  ...
  AlertTriangle, RefreshCw, ShieldAlert, BadgeInfo 
} from "lucide-react";
      ...
      <div className="space-y-4">
        ...
        <Card className="space-y-4">
          ...
          <form onSubmit={handleSearch} className="flex gap-2">
            <input
              type="text"
              placeholder="Enter Mobile (e.g. 91-2345-6789-0123) or Token (e.g. A-045)..."
              value={searchVal}
                  ...
                  {searchResults.map((rx: any) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="mt-2">
                          <Tag tone={rx.status === "DISPENSED" ? "green" : rx.status === "EXPIRED" ? "red" : "amber"}>
                            {rx.status}
                          </Tag>
                        </div>
                      </button>
                ...
                {activeRx && (
                  <Card className="space-y-4 animate-in fade-in duration-200">
                    <div className="flex flex-wrap items-center justify-between gap-3 border-b border-white/5 pb-3">
                      ...
                      <Tag tone={activeRx.status === "DISPENSED" ? "green" : activeRx.status === "EXPIRED" ? "red" : "amber"}>
                        {activeRx.status}
                      </Tag>
                    </div>
